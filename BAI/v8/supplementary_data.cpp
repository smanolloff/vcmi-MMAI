...
namespace MMAI::BAI::V8 {
    const Schema::V8::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V8::Hexes{};
    ...
    const Schema::V8::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V8::Stacks{};
    ...
    const Schema::V8::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V8::AttackLogs{};
