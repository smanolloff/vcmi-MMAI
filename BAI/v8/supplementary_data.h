...
namespace MMAI::BAI::V8 {
    ...
    class SupplementaryData : public Schema::V8::ISupplementaryData {
    public:
        ...
        const Schema::V8::Hexes getHexes() const override;
        const Schema::V8::Stacks getStacks() const override;
        const Schema::V8::AttackLogs getAttackLogs() const override;
        const Schema::V8::IGlobalStats* getGlobalStatsLeft() const override { return lgstats; }
        const Schema::V8::IGlobalStats* getGlobalStatsRight() const override { return rgstats; }
