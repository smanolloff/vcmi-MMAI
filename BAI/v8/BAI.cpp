...
#include "BAI/v8/hexactmask.h"
#include "BAI/v8/render.h"
    ...
    Schema::Action BAI::getNonRenderAction() {
        ...
        while (action == Schema::ACTION_RENDER_ANSI) {
            if (state->supdata->ansiRender.empty()) {
                ...
                state->supdata->type = Schema::V8::ISupplementaryData::Type::ANSI_RENDER;
            }
        ...
        state->supdata->type = Schema::V8::ISupplementaryData::Type::REGULAR;
        return action;
    }
