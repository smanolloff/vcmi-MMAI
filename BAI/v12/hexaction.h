...
namespace MMAI::BAI::V12 {
    using GlobalAction = Schema::V12::GlobalAction;
    using HexAction = Schema::V12::HexAction;
    ...
    static_assert(EI(GlobalAction::_count) == Schema::V12::N_NONHEX_ACTIONS);
    static_assert(EI(HexAction::_count) == Schema::V12::N_HEX_ACTIONS);
