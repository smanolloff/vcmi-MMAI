...
namespace MMAI::BAI::V12 {
    const Schema::V12::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V12::Hexes{};
    ...
    const Schema::V12::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V12::Stacks{};
    ...
    const Schema::V12::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V12::AttackLogs{};
    ...
    const Schema::V12::StateTransitions SupplementaryData::getStateTransitions() const {
        auto res = Schema::V12::StateTransitions{};
