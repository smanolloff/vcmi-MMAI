...
#include "BAI/v12/attack_log.h"
#include "BAI/v12/battlefield.h"
...
namespace MMAI::BAI::V12 {
    ...
    class SupplementaryData : public Schema::V12::ISupplementaryData {
    public:
        ...
        const Schema::V12::Stacks getStacks() const override;
        const Schema::V12::Hexes getHexes() const override;
        const Schema::V12::AttackLogs getAttackLogs() const override;
        const Schema::V12::StateTransitions getStateTransitions() const override;
        const Schema::V12::IGlobalStats* getGlobalStats() const override { return gstats; }
        const Schema::V12::IPlayerStats* getLeftPlayerStats() const override { return lpstats; }
        const Schema::V12::IPlayerStats* getRightPlayerStats() const override { return rpstats; }
