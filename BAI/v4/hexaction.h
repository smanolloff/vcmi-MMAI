...
namespace MMAI::BAI::V4 {
    ...
    using HexAction = Schema::V4::HexAction;
    ...
    static_assert(EI(NonHexAction::count) == Schema::V4::N_NONHEX_ACTIONS);
    static_assert(EI(HexAction::_count) == Schema::V4::N_HEX_ACTIONS);
