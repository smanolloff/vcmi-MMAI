...
namespace MMAI::BAI::V4 {
    ...
    const Schema::V4::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V4::Stacks{};
    ...
    const Schema::V4::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V4::AttackLogs{};
