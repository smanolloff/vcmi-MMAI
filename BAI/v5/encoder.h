...
namespace MMAI::BAI::V5 {
    using MiscAttribute = Schema::V5::MiscAttribute;
    using HexAttribute = Schema::V5::HexAttribute;
    using StackAttribute = Schema::V5::StackAttribute;
    ...
    public:
        ...
        static void Encode(const int a, const Schema::V5::Encoding e, const int n, const int v, const int vmax, BS &vec);
