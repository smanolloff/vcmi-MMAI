...
namespace MMAI::BAI::V5 {
    const Schema::V5::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V5::Hexes{};
    ...
    const Schema::V5::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V5::Stacks{};
    ...
    const Schema::V5::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V5::AttackLogs{};
