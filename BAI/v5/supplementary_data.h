...
#include "BAI/v5/attack_log.h"
#include "BAI/v5/battlefield.h"
...
namespace MMAI::BAI::V5 {
    ...
    class SupplementaryData : public Schema::V5::ISupplementaryData {
    public:
        ...
        const Schema::V5::Hexes getHexes() const override;
        const Schema::V5::Stacks getStacks() const override;
        const Schema::V5::AttackLogs getAttackLogs() const override;
        const Schema::V5::IMisc* getMisc() const override { return misc.get(); }
