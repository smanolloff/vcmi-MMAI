...
#include "BAI/v11/supplementary_data.h"
#include "common.h"

namespace MMAI::BAI::V11 {
    const Schema::V11::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V11::Hexes{};
    ...
    const Schema::V11::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V11::Stacks{};
    ...
    const Schema::V11::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V11::AttackLogs{};
    ...
    const Schema::V11::StateTransitions SupplementaryData::getStateTransitions() const {
        auto res = Schema::V11::StateTransitions{};
