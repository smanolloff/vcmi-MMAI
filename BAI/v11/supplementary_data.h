...
#include "BAI/v11/attack_log.h"
#include "BAI/v11/battlefield.h"
#include "BAI/v11/player_stats.h"
#include "BAI/v11/global_stats.h"
// #include "BAI/v11/util.h"
...
namespace MMAI::BAI::V11 {
    ...
    class SupplementaryData : public Schema::V11::ISupplementaryData {
    public:
        ...
        const Schema::V11::Stacks getStacks() const override;
        const Schema::V11::Hexes getHexes() const override;
        const Schema::V11::AttackLogs getAttackLogs() const override;
        const Schema::V11::StateTransitions getStateTransitions() const override;
        const Schema::V11::IGlobalStats* getGlobalStats() const override { return gstats; }
        const Schema::V11::IPlayerStats* getLeftPlayerStats() const override { return lpstats; }
        const Schema::V11::IPlayerStats* getRightPlayerStats() const override { return rpstats; }
