...
namespace MMAI::BAI::V11 {
    using GlobalAction = Schema::V11::GlobalAction;
    using HexAction = Schema::V11::HexAction;
    ...
    static_assert(EI(GlobalAction::_count) == Schema::V11::N_NONHEX_ACTIONS);
    static_assert(EI(HexAction::_count) == Schema::V11::N_HEX_ACTIONS);
