...
namespace MMAI::BAI::V11 {
    using GlobalAttribute = Schema::V11::GlobalAttribute;
    using PlayerAttribute = Schema::V11::PlayerAttribute;
    using HexAttribute = Schema::V11::HexAttribute;
    using LinkAttribute = Schema::V11::LinkAttribute;
    ...
    public:
        ...
        static void Encode(const char* attrtype, const int a, const Schema::V11::Encoding e, const int n, int v, const int vmax, BS &vec);
