...
namespace MMAI::BAI::V10 {
    ...
    using HexAction = Schema::V10::HexAction;
    ...
    static_assert(EI(NonHexAction::count) == Schema::V10::N_NONHEX_ACTIONS);
    static_assert(EI(HexAction::_count) == Schema::V10::N_HEX_ACTIONS);
