...
namespace MMAI::BAI::V10 {
    const Schema::V10::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V10::Hexes{};
    ...
    const Schema::V10::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V10::Stacks{};
    ...
    const Schema::V10::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V10::AttackLogs{};
    ...
    const Schema::V10::StateTransitions SupplementaryData::getStateTransitions() const {
