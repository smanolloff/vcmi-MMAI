...
namespace MMAI::BAI::V6 {
    using MiscAttribute = Schema::V6::MiscAttribute;
    using HexAttribute = Schema::V6::HexAttribute;
    using StackAttribute = Schema::V6::StackAttribute;
    ...
    public:
        ...
        static void Encode(const int a, const Schema::V6::Encoding e, const int n, const int v, const int vmax, BS &vec);
