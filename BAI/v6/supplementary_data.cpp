...
namespace MMAI::BAI::V6 {
    const Schema::V6::Hexes SupplementaryData::getHexes() const {
        ASSERT(battlefield, "getHexes() called when battlefield is null");
        auto res = Schema::V6::Hexes{};
    ...
    const Schema::V6::Stacks SupplementaryData::getStacks() const {
        ASSERT(battlefield, "getStacks() called when battlefield is null");
        auto res = Schema::V6::Stacks{};
    ...
    const Schema::V6::AttackLogs SupplementaryData::getAttackLogs() const {
        auto res = Schema::V6::AttackLogs{};
