...
namespace MMAI::BAI::V6 {
    ...
    using HexAction = Schema::V6::HexAction;
    ...
    static_assert(EI(NonHexAction::count) == Schema::V6::N_NONHEX_ACTIONS);
    static_assert(EI(HexAction::_count) == Schema::V6::N_HEX_ACTIONS);
