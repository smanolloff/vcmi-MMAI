...
namespace MMAI::Schema::V12 {
    ...
    namespace {
        ...
        inline constexpr auto LBE = Encoding::LOGBIN_EXPLICIT_NULL;
        inline constexpr auto LBI = Encoding::LOGBIN_IMPLICIT_NULL;
        inline constexpr auto LBM = Encoding::LOGBIN_MASKING_NULL;
        inline constexpr auto LBS = Encoding::LOGBIN_STRICT_NULL;
        inline constexpr auto LBZ = Encoding::LOGBIN_ZERO_NULL;
    ...
    constexpr std::tuple<T, Encoding, int, int> E4(T a, Encoding e, int vmax) {
        ...
        // "0" is a category => +1
        case LBE: return {a, e, LogBins(vmax)+2, vmax};
        case LBI: return {a, e, LogBins(vmax)+1, vmax};
        case LBM: return {a, e, LogBins(vmax)+1, vmax};
        case LBS: return {a, e, LogBins(vmax)+1, vmax};
        case LBZ: return {a, e, LogBins(vmax)+1, vmax};
    ...
    constexpr auto lb = LogBins(1000);
    ...
    constexpr HexEncoding HEX_ENCODING {
        ...
        E4(HA::STACK_QUANTITY,          LB, STACK_QTY_MAX),
